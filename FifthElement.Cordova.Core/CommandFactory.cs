...
namespace FifthElement.Cordova.Core
{
    ...
    public static class CommandFactory
    {
        ...
        /// </summary>
        private static readonly string CustomPluginNamespacePrefix = "FifthElement.Cordova.Commands.";

        private static readonly string BaseCommandNamespacePrefix = "FifthElement.Cordova.Core.";
